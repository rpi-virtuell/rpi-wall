...
class Shortcodes
{
    ...
    static function display_user($user_id, $size)
    {
        ...
        <div class="user-grid">
            ...
            <div class="user-name"><a
                        href="<?php echo wp_ulike_pro_get_user_profile_permalink($user_id) ?>"><?php echo $user->display_name; ?></a>
            </div>
        </div>
        <?php
    }
    ...
    static function display_user_name($user_id)
    {
        ...
        <span class="user-name"><a
                    href="<?php echo wp_ulike_pro_get_user_profile_permalink($user_id) ?>"><?php echo $user->display_name; ?></a></span>
        <?php
    }
